...
def postcode_to_sector(postcode):
    """A function to convert a postcode to a sector by extracting
    ...
    'SW1A 1'
    """
    # Cleaning the postcode by removing leading/trailing
    # white spaces and converting to uppercase
...
def postcode_to_district(postcode):
    """A function to convert a postcode to a district by
...
# Cleaning the sector data def normalise_sector
def normalise_sector(sector):
    """A function to normalise the postcode sector by removing
...
# Cleaning the district data def normalise_
def normalise_district(district):
    """A function to normalise the postcode district by removing
    leading/trailing white spaces and converting to uppercase.
    Arguments:
